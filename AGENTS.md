# AGENTS local do projeto

Este arquivo complementa o AGENTS global e define regras permanentes para a raiz
do repositório.

## Precedência local
- Siga nesta ordem: prompt explícito do usuário, este `AGENTS.md` local e o
  AGENTS global.
...
- Não altere nem apague `AGENTS.md` por iniciativa própria.
